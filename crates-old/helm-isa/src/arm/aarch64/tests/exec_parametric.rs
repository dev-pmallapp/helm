...
gen_tests!(
    ...
    (
        rorv64_s4,
        dp2(1, 0b001011, 2, 1, 0),
        0xF0u64,
        4u64,
        0x0000_0000_0000_000Fu64
    ),
    (
        rorv64_s32,
        dp2(1, 0b001011, 2, 1, 0),
...
gen_imm!(
    ...
    (
        add_imm64_v100,
        add_sub_imm(1, 0, 0, 100, 1, 0),
        0u64,
        100u64
    ),
    (
        add_imm64_v1k,
        add_sub_imm(1, 0, 0, 1000, 1, 0),
        0u64,
        1000u64
    ),
    (
        add_imm64_vfff,
        add_sub_imm(1, 0, 0, 0xFFF, 1, 0),
        0u64,
        0xFFFu64
    ),
    ...
    (
        sub_imm64_v100,
        add_sub_imm(1, 1, 0, 100, 1, 0),
        200u64,
        100u64
    ),
    (
        sub_imm64_vfff,
        add_sub_imm(1, 1, 0, 0xFFF, 1, 0),
        0x1000u64,
        1u64
    ),
    // 32-bit
...
fn adds64(rm: u32, rn: u32) -> u32 {
    (1 << 31) | (1 << 29) | (0b01011 << 24) | (rm << 16) | (rn << 5) | 31
}
fn subs64(rm: u32, rn: u32) -> u32 {
    (1 << 31) | (1 << 30) | (1 << 29) | (0b01011 << 24) | (rm << 16) | (rn << 5) | 31
}
fn adds32(rm: u32, rn: u32) -> u32 {
    (0 << 31) | (1 << 29) | (0b01011 << 24) | (rm << 16) | (rn << 5) | 31
}
fn subs32(rm: u32, rn: u32) -> u32 {
    (0 << 31) | (1 << 30) | (1 << 29) | (0b01011 << 24) | (rm << 16) | (rn << 5) | 31
}
...
gen_1src!(
    ...
    (
        ubfx64_b0,
        bitfield(1, 0b10, 1, 0, 0, 1, 0),
        0xFFFF_FFFF_FFFF_FFFFu64,
        1u64
    ),
    (
        ubfx64_b1,
        bitfield(1, 0b10, 1, 1, 1, 1, 0),
        0xFFFF_FFFF_FFFF_FFFFu64,
        1u64
    ),
    ...
    (
        ubfx64_byte0,
        bitfield(1, 0b10, 1, 0, 7, 1, 0),
        0xABCD_EF01u64,
        0x01u64
    ),
    (
        ubfx64_byte1,
        bitfield(1, 0b10, 1, 8, 15, 1, 0),
        0xABCD_EF01u64,
        0xEFu64
    ),
    (
        ubfx64_byte2,
        bitfield(1, 0b10, 1, 16, 23, 1, 0),
        0xABCD_EF01u64,
        0xCDu64
    ),
    (
        ubfx64_byte3,
        bitfield(1, 0b10, 1, 24, 31, 1, 0),
        0xABCD_EF01u64,
        0xABu64
    ),
    (
        ubfx64_hw0,
        bitfield(1, 0b10, 1, 0, 15, 1, 0),
        0xDEAD_BEEFu64,
        0xBEEFu64
    ),
    (
        ubfx64_hw1,
        bitfield(1, 0b10, 1, 16, 31, 1, 0),
        0xDEAD_BEEFu64,
        0xDEADu64
    ),
    // UBFX 32-bit
    ...
    (
        sbfx32_b0_neg,
        bitfield(0, 0b00, 0, 0, 0, 1, 0),
        1u64,
        0xFFFF_FFFFu64
    ),
    (
        sbfx32_byte0_n,
        bitfield(0, 0b00, 0, 0, 7, 1, 0),
        0x80u64,
        0xFFFF_FF80u64
    ),
);
...
gen_1src!(
    (
        lsr64_by1,
        bitfield(1, 0b10, 1, 1, 63, 1, 0),
        0x100u64,
        0x80u64
    ),
    (
        lsr64_by2,
        bitfield(1, 0b10, 1, 2, 63, 1, 0),
        0x100u64,
        0x40u64
    ),
    (
    ...
    (
        lsr64_by8b,
        bitfield(1, 0b10, 1, 8, 63, 1, 0),
        0x100u64,
        0x1u64
    ),
    (
        lsr64_by16,
        bitfield(1, 0b10, 1, 16, 63, 1, 0),
        0x10000u64,
        0x1u64
    ),
    (
        lsr64_by32b,
        bitfield(1, 0b10, 1, 32, 63, 1, 0),
        0x1_0000_0000u64,
        0x1u64
    ),
    ...
    (
        lsl64_by16b,
        bitfield(1, 0b10, 1, 48, 47, 1, 0),
        1u64,
        0x10000u64
    ),
    (
        asr64_by1b,
        bitfield(1, 0b00, 1, 1, 63, 1, 0),
        (-4i64) as u64,
        (-2i64) as u64
    ),
    (
        asr64_by2b,
        bitfield(1, 0b00, 1, 2, 63, 1, 0),
        (-4i64) as u64,
        (-1i64) as u64
    ),
    (
        asr64_by4c,
        bitfield(1, 0b00, 1, 4, 63, 1, 0),
        (-16i64) as u64,
        (-1i64) as u64
    ),
    ...
    (
        lsr32_by1,
        bitfield(0, 0b10, 0, 1, 31, 1, 0),
        0x100u64,
        0x80u64
    ),
    (
        lsr32_by4,
        bitfield(0, 0b10, 0, 4, 31, 1, 0),
        0x100u64,
        0x10u64
    ),
    (
        lsr32_by8,
        bitfield(0, 0b10, 0, 8, 31, 1, 0),
        0x100u64,
        0x1u64
    ),
    (
    ...
    (
        lsl32_by16,
        bitfield(0, 0b10, 0, 16, 15, 1, 0),
        1u64,
        0x10000u64
    ),
    (
        asr32_by1,
        bitfield(0, 0b00, 0, 1, 31, 1, 0),
        0x8000_0000u64,
        0xC000_0000u64
    ),
    (
        asr32_by4b,
        bitfield(0, 0b00, 0, 4, 31, 1, 0),
        0x8000_0000u64,
        0xF800_0000u64
    ),
...
gen_ext!(
    ...
    (
        ...
        100u64,
        0x80u64,
        (100u32.wrapping_add((-128i32) as u32)) as u64
    ),
    (
        ext_sub32_uxtb,
        0,
