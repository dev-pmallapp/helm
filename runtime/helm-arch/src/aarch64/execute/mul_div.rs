    ...
    match insn.opcode {
        ...
        Udiv => {
            let (rn, rm) = if insn.sf {
                ...
                (
                    a.read_x(insn.rn) as u32 as u64,
                    a.read_x(insn.rm) as u32 as u64,
                )
            };
        ...
        Sdiv => {
            let (rn, rm) = if insn.sf {
                ...
                (
                    a.read_x(insn.rn) as u32 as i32 as i64,
                    a.read_x(insn.rm) as u32 as i32 as i64,
                )
            };
