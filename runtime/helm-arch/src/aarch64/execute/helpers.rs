...
pub fn redirect_sysreg(a: &Aarch64ArchState, encoded: u32) -> u32 {
    ...
    match encoded {
        ...
        0b11_000_0101_0010_000 => 0b11_100_0101_0010_000, // ESR_EL1 -> ESR_EL2
        0b11_000_0001_0000_010 => 0b11_100_0001_0001_010, // CPACR_EL1 -> CPTR_EL2
        0b11_000_1101_0000_001 => 0b11_100_1101_0000_001, // CONTEXTIDR_EL1 -> CONTEXTIDR_EL2
        _ => encoded,
    }
}
