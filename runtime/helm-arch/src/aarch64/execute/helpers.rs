...
pub(super) fn read_sysreg(a: &Aarch64ArchState, encoded: u32) -> u64 {
    ...
    match encoded {
       ...
       0b11_011_1110_0011_010 => a.cntv_cval_el0,
        ...
        // correct boot path.  Listed here for robustness: returning 0 (SRE=0)
        // tells the kernel GICv3 SRE is disabled; it falls back to MMIO GICv2.
        // ICC_SRE_EL1    (3, 0, 12, 12, 5)
        0b11_000_1100_1100_101 => 0,
        // ICC_CTLR_EL1   (3, 0, 12, 12, 4)
        0b11_000_1100_1100_100 => 0,
        // ICC_PMR_EL1    (3, 0,  4,  6, 0)
        0b11_000_0100_0110_000 => 0,
        // ICC_IAR1_EL1   (3, 0, 12, 12, 0)
        0b11_000_1100_1100_000 => 0,
        // ICC_HPPIR1_EL1 (3, 0, 12, 12, 2)
        0b11_000_1100_1100_010 => 0,
