...
| L1–L2 | **APE** | 1–100 MIPS | Per-class instruction latency, cache-level stalls, branch penalty |
...
| `timing` | `ApeModelDetailed` (defaults) | General-purpose |
| `minor` | `ApeModelDetailed` (reduced div/branch) | In-order-like |
| `o3` | `ApeModelDetailed` (full latencies) | OoO-like |
| `big` | `ApeModelDetailed` (big-core tuned) | ARM big.LITTLE big core |
