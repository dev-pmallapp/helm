...
flag_test!(ands64_1_1,         ands_reg(1,2,1,31), 1u64, 1u64,             false,false,false,false);
flag_test!(ands64_0_0,         ands_reg(1,2,1,31), 0u64, 0u64,             false,true, false,false);
flag_test!(ands64_ff_0,        ands_reg(1,2,1,31), 0xFFu64, 0u64,          false,true, false,false);
flag_test!(ands64_neg_neg,     ands_reg(1,2,1,31), 0x8000_0000_0000_0001u64, 0x8000_0000_0000_0002u64, true,false,false,false);
flag_test!(ands32_1_1,         ands_reg(0,2,1,31), 1u64, 1u64,             false,false,false,false);
flag_test!(ands32_0_0,         ands_reg(0,2,1,31), 0u64, 0u64,             false,true, false,false);
flag_test!(ands32_neg_neg,     ands_reg(0,2,1,31), 0x8000_0001u64, 0x8000_0002u64, true,false,false,false);
