...
fn interp_sub() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 50 },
            TcgOp::Movi { dst: t(1), value: 8 },
...
fn interp_mul() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 7 },
            TcgOp::Movi { dst: t(1), value: 6 },
...
fn interp_and_or_xor() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0xFF },
            TcgOp::Movi { dst: t(1), value: 0x0F },
...
fn interp_load_store_roundtrip() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0x2000 },   // addr
            TcgOp::Movi { dst: t(1), value: 0xDEADBEEF }, // value
...
fn interp_read_write_reg() {
    let block = make_block(
        vec![
            ...
            TcgOp::Addi { dst: t(1), a: t(0), imm: 100 },
            TcgOp::WriteReg { reg_id: 6, src: t(1) },
            TcgOp::ExitTb,
        ],
        1,
    );
...
fn interp_brcond_taken() {
    let block = make_block(
        vec![
            ...
            TcgOp::ExitTb,
            TcgOp::Label { id: 0 },
            TcgOp::Movi { dst: t(1), value: 42 },     // taken path
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
        ],
        1,
...
fn interp_brcond_not_taken() {
    let block = make_block(
        vec![
            ...
            TcgOp::BrCond { cond: t(0), label: 0 },
            TcgOp::Movi { dst: t(1), value: 999 },    // fallthrough
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
            TcgOp::Label { id: 0 },
...
fn interp_syscall_exit() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 93 },   // exit syscall nr
...
fn interp_goto_tb_chain() {
    let block = make_block(
        vec![TcgOp::GotoTb { target_pc: 0x2000 }],
        1,
    );
    let mut regs = empty_regs();
    let mut mem = make_mem();
    let mut interp = TcgInterp::new();
    let result = interp.exec_block(&block, &mut regs, &mut mem).unwrap();
    assert!(matches!(result.exit, InterpExit::Chain { target_pc: 0x2000 }));
}
...
fn interp_zext() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0xFFFF_FFFF_FFFF_FF80 },
            TcgOp::Zext { dst: t(1), src: t(0), from_bits: 8 },
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
        ],
        1,
...
fn interp_set_eq() {
    let block = make_block(
        vec![
            ...
            TcgOp::SetEq { dst: t(2), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::Movi { dst: t(3), value: 6 },
            TcgOp::SetEq { dst: t(4), a: t(0), b: t(3) },
