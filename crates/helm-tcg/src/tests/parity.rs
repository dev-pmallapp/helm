...
fn run_parity(block: &TcgBlock, init_regs: &[u64; NUM_REGS]) -> ([u64; NUM_REGS], [u64; NUM_REGS]) {
    ...
    let threaded_result = exec_threaded(&compiled, &mut threaded_regs, &mut threaded_mem, &mut sysregs)
...
fn parity_sub_wrapping() {
    let block = make_block(
        vec![
            ...
            TcgOp::Sub { dst: t(2), a: t(0), b: t(1) }, // 5 - 10 wraps
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_mul_overflow() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: u64::MAX },
            TcgOp::Movi { dst: t(1), value: 2 },
            TcgOp::Mul { dst: t(2), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_div() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 100 },
            TcgOp::Movi { dst: t(1), value: 7 },
            TcgOp::Div { dst: t(2), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_div_by_zero() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 42 },
            TcgOp::Movi { dst: t(1), value: 0 },
            TcgOp::Div { dst: t(2), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
...
fn parity_addi_negative() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 10 },
            TcgOp::Addi { dst: t(1), a: t(0), imm: -3 },
...
fn parity_and_or_xor_not() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0xF0F0 },
            TcgOp::Movi { dst: t(1), value: 0xFF00 },
            TcgOp::And { dst: t(2), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::Or  { dst: t(3), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 1, src: t(3) },
            TcgOp::Xor { dst: t(4), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 2, src: t(4) },
            TcgOp::Not { dst: t(5), src: t(0) },
    ...
    for i in 0..4 { assert_eq!(ir[i], th[i]); }
}
...
fn parity_shifts() {
    ...
    for i in 0..3 { assert_eq!(ir[i], th[i]); }
}
...
fn parity_sext_zext() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0x80 }, // -128 in 8-bit
    ...
    assert_eq!(ir[1], 0x80);
    for i in 0..2 { assert_eq!(ir[i], th[i]); }
}
...
fn parity_sext_16bit() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0x8000 }, // -32768 in 16-bit
            TcgOp::Sext { dst: t(1), src: t(0), from_bits: 16 },
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_set_comparisons() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 5 },
            TcgOp::Movi { dst: t(1), value: 5 },
            TcgOp::Movi { dst: t(2), value: 10 },
            // SetEq: 5==5 → 1
            TcgOp::SetEq { dst: t(3), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(3) },
            // SetNe: 5!=10 → 1
            TcgOp::SetNe { dst: t(4), a: t(0), b: t(2) },
            TcgOp::WriteReg { reg_id: 1, src: t(4) },
            // SetLt: 5 < 10 signed → 1
            TcgOp::SetLt { dst: t(5), a: t(0), b: t(2) },
            TcgOp::WriteReg { reg_id: 2, src: t(5) },
            // SetGe: 10 >= 5 signed → 1
            TcgOp::SetGe { dst: t(6), a: t(2), b: t(0) },
            TcgOp::WriteReg { reg_id: 3, src: t(6) },
            TcgOp::ExitTb,
        ],
        1,
    );
...
fn parity_set_negative_comparisons() {
    ...
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: u64::MAX },  // -1 as signed
            TcgOp::Movi { dst: t(1), value: 1 },
            // SetLt: -1 < 1 signed → 1
            TcgOp::SetLt { dst: t(2), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            // SetGe: 1 >= -1 signed → 1
            TcgOp::SetGe { dst: t(3), a: t(1), b: t(0) },
            TcgOp::WriteReg { reg_id: 1, src: t(3) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_load_store_1_byte() {
    let block = make_block(
        vec![
            ...
            TcgOp::Movi { dst: t(1), value: 0xAB },
            TcgOp::Store { addr: t(0), val: t(1), size: 1 },
            TcgOp::Load  { dst: t(2), addr: t(0), size: 1 },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_load_store_2_bytes() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0x2000 },
            TcgOp::Movi { dst: t(1), value: 0xCAFE },
            TcgOp::Store { addr: t(0), val: t(1), size: 2 },
            TcgOp::Load  { dst: t(2), addr: t(0), size: 2 },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_load_store_8_bytes() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0x2000 },
            TcgOp::Movi { dst: t(1), value: 0xDEAD_BEEF_1234_5678u64 },
            TcgOp::Store { addr: t(0), val: t(1), size: 8 },
            TcgOp::Load  { dst: t(2), addr: t(0), size: 8 },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_read_write_reg() {
    ...
    let block = make_block(
        vec![
            TcgOp::ReadReg { dst: t(0), reg_id: 5 },
            TcgOp::Addi { dst: t(1), a: t(0), imm: 1 },
            TcgOp::WriteReg { reg_id: 7, src: t(1) },
            TcgOp::ExitTb,
        ],
        1,
    );
...
fn parity_brcond_taken() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 1 }, // cond = true
            TcgOp::BrCond { cond: t(0), label: 0 },
            TcgOp::Movi { dst: t(1), value: 999 }, // skipped
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
            TcgOp::Label { id: 0 },
...
fn parity_brcond_not_taken() {
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0 }, // cond = false
            TcgOp::BrCond { cond: t(0), label: 0 },
            TcgOp::Movi { dst: t(1), value: 77 }, // fallthrough
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
            TcgOp::Label { id: 0 },
            TcgOp::Movi { dst: t(1), value: 42 }, // not reached
            TcgOp::WriteReg { reg_id: 0, src: t(1) },
            TcgOp::ExitTb,
        ],
        1,
...
fn parity_unconditional_br() {
    let block = make_block(
        vec![
            ...
            TcgOp::Br { label: 1 },
            TcgOp::Movi { dst: t(0), value: 999 }, // skipped
            TcgOp::WriteReg { reg_id: 0, src: t(0) },
            TcgOp::ExitTb,
            TcgOp::Label { id: 1 },
            TcgOp::WriteReg { reg_id: 0, src: t(0) }, // writes 1
            TcgOp::ExitTb,
        ],
        1,
    );
...
fn parity_fibonacci_5() {
    ...
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0 }, // a
            TcgOp::Movi { dst: t(1), value: 1 }, // b
            // iter 1
            TcgOp::Add { dst: t(2), a: t(0), b: t(1) },
            TcgOp::Mov { dst: t(0), src: t(1) },
            TcgOp::Mov { dst: t(1), src: t(2) },
            // iter 2
            TcgOp::Add { dst: t(2), a: t(0), b: t(1) },
            TcgOp::Mov { dst: t(0), src: t(1) },
            TcgOp::Mov { dst: t(1), src: t(2) },
...
fn parity_sum_loop_via_br() {
    ...
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0 },  // accumulator
            TcgOp::Movi { dst: t(1), value: 1 },
            TcgOp::Add { dst: t(0), a: t(0), b: t(1) },
            TcgOp::Movi { dst: t(1), value: 2 },
            TcgOp::Add { dst: t(0), a: t(0), b: t(1) },
            TcgOp::Movi { dst: t(1), value: 3 },
            TcgOp::Add { dst: t(0), a: t(0), b: t(1) },
            TcgOp::Movi { dst: t(1), value: 4 },
            TcgOp::Add { dst: t(0), a: t(0), b: t(1) },
            TcgOp::Movi { dst: t(1), value: 5 },
            TcgOp::Add { dst: t(0), a: t(0), b: t(1) },
            TcgOp::WriteReg { reg_id: 0, src: t(0) },
...
fn parity_dc_zva_zeroes_memory() {
    ...
    let block = make_block(
        vec![
            TcgOp::Movi { dst: t(0), value: 0x2040 }, // addr inside cache line at 0x2040
            TcgOp::DcZva { addr: t(0) },
            TcgOp::Movi { dst: t(1), value: 0x2040 },
            TcgOp::Load { dst: t(2), addr: t(1), size: 8 },
            TcgOp::WriteReg { reg_id: 0, src: t(2) },
            TcgOp::ExitTb,
        ],
        1,
